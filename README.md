...
> Lineage: 4 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\coupon-redemptions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\coupon-redemptions) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package coupon-redemptions -Apply
