 ...
 * - whitelist filtrů: [ 'id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ]
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ], true);
            $parts = [];
