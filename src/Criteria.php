...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'coupons' => 'j1', 'orders' => 'j2', 'users' => 'j3' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\CouponRedemptions\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\CouponRedemptions\Definitions::softDeleteColumn();
