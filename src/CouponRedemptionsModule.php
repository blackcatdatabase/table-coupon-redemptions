...
final class CouponRedemptionsModule implements ModuleInterface
{
    public function name(): string { return 'table-coupon_redemptions'; }
    public function table(): string { return 'coupon_redemptions'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-coupons', 'table-orders', 'table-tenants', 'table-users' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_cr_coupon', 'fk_cr_order', 'fk_cr_tenant', 'fk_cr_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_cr_coupon', 'idx_cr_order', 'idx_cr_tenant_coupon', 'idx_cr_tenant_order', 'idx_cr_tenant_user', 'idx_cr_user', 'ux_cr_tenant_order_coupon' ],
            'foreignKeys' => [ 'fk_cr_coupon', 'fk_cr_order', 'fk_cr_tenant', 'fk_cr_user' ],
        ];
    }
}
