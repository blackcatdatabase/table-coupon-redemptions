...
final class CouponRedemptionsModule implements ModuleInterface {
    ...
    /** @return string[] */
    public function dependencies(): array { return [ 'table-coupons', 'table-orders', 'table-users' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_cr_coupon', 'idx_cr_order', 'idx_cr_user' ];
        $fks     = [ 'fk_cr_coupon', 'fk_cr_order', 'fk_cr_user' ];
        $missingIdx = [];
        $missingFk  = [];
