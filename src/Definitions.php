...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'coupon_id', 'user_id', 'order_id', 'redeemed_at', 'amount_applied' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'order_id', 'coupon_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'coupon_id', 'user_id', 'order_id' ]; }
