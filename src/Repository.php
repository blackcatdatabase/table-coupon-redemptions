...
use BlackCat\Database\Packages\CouponRedemptions\Repository\CouponRedemptionRepository as GeneratedRepository;
...
{
  private CouponRedemptionRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof CouponRedemptionRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected CouponRedemptionRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto|null { return $this->repo->getById($id, $asDto); }
