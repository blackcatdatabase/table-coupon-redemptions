...
use BlackCat\Database\Packages\CouponRedemptions\Repository\CouponRedemptionRepository;
...
{
    private CouponRedemptionRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new CouponRedemptionRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto|null
    {
