...
final class CouponRedemptionDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'coupon_id' => 'couponId', 'user_id' => 'userId', 'order_id' => 'orderId', 'redeemed_at' => 'redeemedAt', 'amount_applied' => 'amountApplied' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'coupon_id', 'user_id', 'order_id' ];
    /** @var string[] */
    ...
    public static function fromRow(array $row): CouponRedemptionDto {
        ...
        $rc   = new \ReflectionClass(CouponRedemptionDto::class);
