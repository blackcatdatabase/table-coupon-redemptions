...
namespace BlackCat\Database\Packages\CouponRedemptions\Mapper;

use BlackCat\Database\Packages\CouponRedemptions\Dto\CouponRedemptionDto;
use BlackCat\Database\Packages\CouponRedemptions\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CouponRedemptionDto:
...
final class CouponRedemptionDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'coupon_id', 'user_id', 'order_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'amount_applied' ];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'redeemed_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): CouponRedemptionDto
    {
        /** @var CouponRedemptionDto */
    ...
    public static function fromRowOrNull(?array $row): ?CouponRedemptionDto
    {
     ...
     *
     * @param CouponRedemptionDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(CouponRedemptionDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CouponRedemptionDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CouponRedemptionDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,CouponRedemptionDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,CouponRedemptionDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CouponRedemptionDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CouponRedemptionDto>
     */
